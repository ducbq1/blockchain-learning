const { resolve_gen, base58_gen, compress_gen, sign_gen, address_gen, public_gen, payload_gen, resolve_gen_did } = require("./crypto_mainet");
...
console.log(payload_gen(`did:resolve:${did1}.${did2}.${did3}-${sign1}.${sign2}.${sign3}-${root_hash}`))
